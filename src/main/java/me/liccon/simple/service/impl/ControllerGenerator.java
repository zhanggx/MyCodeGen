...
public class ControllerGenerator extends CodeGeneratorManager implements CodeGenerator {
	...
	public ControllerGenerator(DataColumnMapper mapper, String dbName,DataTable table){
		this.mapper=mapper;
	...
	public void genCode(String modelName, String sign) {
		...
		String customMapping = "/" + sign + "/controller/";
		...
		try {
			...
			File controllerFile = new File(PROJECT_PATH + JAVA_PATH + packagePath+ customMapping
